# deploy-sepolia:
# 	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account eth_sepolia_key --sender $(eth_sepolia_key_address) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY)
